  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-lg md:text-xl mb-8 max-w-lg">
                ...
                Create personalized itineraries, get visa help, and discover local secrets.
              </p>
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a href="#learn-more">
                  <Button variant="outline" className="border-white text-white hover:bg-white/10 w-full sm:w-auto px-8 py-3 h-auto font-medium">
                    Learn More
                  </Button>
                </a>
              </div>
      ...
      <section id="features" className="py-16 bg-neutral-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold font-sans text-neutral-800 mb-4">Unlock the World with MAPA<span className="text-primary">AI</span></h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Our AI-powered travel platform helps Filipino travelers plan the perfect trip with personalized recommendations.
            </p>
          </div>
      ...
      <section id="destinations" className="py-16 bg-neutral-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold font-sans text-neutral-800 mb-4">Popular Destinations</h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Explore breathtaking destinations around the world, all with detailed itineraries powered by MAPA<span className="text-primary">AI</span>.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
              <h2 className="text-3xl font-bold font-sans text-neutral-800 mb-4">Powered by Google Gemini AI</h2>
              <p className="text-lg text-neutral-600 mb-6">
                Our cutting-edge AI technology creates personalized travel experiences based on your unique preferences, budget, and travel style.
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <i className="fas fa-check-circle text-primary mt-1 mr-3"></i>
                  <span>Intelligent budget allocation for maximum experiences</span>
                </li>
                <li className="flex items-start">
                  <i className="fas fa-check-circle text-primary mt-1 mr-3"></i>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold font-sans text-neutral-800 mb-4">What Our Travelers Say</h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Hear from Filipino travelers who have used MAPA<span className="text-primary">AI</span> to plan their perfect trips.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold font-sans text-neutral-800 mb-4">Get in Touch</h2>
              <p className="text-lg text-neutral-600">
                Have questions about MAPA<span className="text-primary">AI</span> or need help with your travel plans? Reach out to us!
              </p>
            </div>
